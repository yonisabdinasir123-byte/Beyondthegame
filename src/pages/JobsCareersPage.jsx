...
// ─── Macro hero: one focal point, one bold CTA ───────────────────────────────
function JcHero() {
...
const SPOTLIGHT_CLUSTERS = [
  {
    ...
    roles: [
      ...
      },
      {
        ...
        steps: [
          'Complete a Level 2 Certificate in Gym Instruction, delivered by providers like YMCA Awards or Active IQ, typically 6 to 10 weeks.',
        ...
        quals: ['Level 2 Certificate in Gym Instruction (6 to 10 weeks, ~£300 to 500)', 'Level 3 Personal Trainer (optional step up)', 'First Aid at Work'],
        opps: {
      ...
      },
      {
        ...
        steps: [
          'Complete the FA Referee Course (Level 7, around £100 to 120, delivered by your county FA, typically 2 days).',
  ...
  },
  {
    ...
    roles: [
      ...
      },
      {
        ...
        steps: [
          'Start with DaVinci Resolve (free professional editing software) and any smartphone with a gimbal (~£30 to 50).',
      ...
      },
      {
        ...
        steps: [
          'Start at a local Step 5 to 7 club, offer to shoot 3 matches for free in exchange for a photo credit and testimonial.',
          'Build a portfolio of 30 to 40 images on a free Adobe Portfolio or Squarespace page, quality over quantity.',
        ...
        opps: {
          text: "Non-league clubs commonly pay £50 to 150 per matchday for a reliable photographer. Regional sports news agencies also hire freelancers for specific fixtures, and you can start right away with the phone in your pocket.",
          links: [
    ...
    roles: [
      {
        ...
        steps: [
          ...
          'Earn a Level 2 Award for Door Supervisors or the Level 2 Award in Spectator Safety (SIA approved, ~£300 to 500).',
          'Build up to Head Steward or Safety Officer as you gain match experience, clubs often fund the Level 3 internally.',
        ],
        quals: ['Level 2 Award in Spectator Safety (SIA, ~£300 to 500)', 'First Aid at Work', 'DBS Check'],
        opps: {
      ...
      },
      {
        ...
        steps: [
          'Complete a Level 3 Award in Nutrition, available via BTEC or Cache-accredited providers, typically 4 to 6 months (~£300 to 600).',
        ...
        quals: ['Level 3 Award in Nutrition (BTEC/Cache, ~£300 to 600)', 'ISSN Foundation Sports Nutrition Certificate', 'Food Hygiene Level 2 (free online)'],
        opps: {
      ...
      },
      {
        ...
        steps: [
          ...
          'Build a portfolio of detailed scouting reports and approach heads of recruitment at Step 3 to 5 clubs directly.',
        ],
...
function RoleCard({ role }) {
  return (
    <GlassCard as="article" tone="light" interactive className="cs-card" role="listitem">
...
function CareerSpotlight() {
  ...
  return (
    <FloatingSection
      ...
      title="Careers built for footballers"
      intro="Roles you may never have considered but are naturally positioned for. Real pathways, real UK qualifications, real opportunities."
      glow="lime"
    >
      <div className="jc-section__inner">
        ...
        {/* Suggest a career */}
        <GlassCard tone="light" className="cs-suggest">
          <div className="cs-suggest__label">
            {/* Prospect: gain framing, an invitation rather than an absence */}
    ...
    <SiteLayout>
      <div className="jc-page">
        ...
        <FloatingSection
          ...
          intro="Tell us what you are into. Subjects, hobbies, skills. We will suggest realistic careers worth exploring."
          glow="teal"
        >
        ...
        <FloatingSection
          ...
          eyebrow="Live Jobs"
          title="Jobs near you"
          intro="Search live vacancies by the kind of work you want and how far you are willing to travel."
          glow="coral"
        >
          {/* Fogg: signal, goal-matched direction to the listings below */}
          {getGoal()?.id === 'find-job' && (
            <PromptCard type="signal">
              Your goal: 💼 Find a Job. Search below by the kind of work and your
              area, then apply to the ones that fit.
            </PromptCard>
          )}
          <JobAdverts />
        </FloatingSection>
        ...
        <FloatingSection
          id="networking"
          eyebrow="Networking Tracker"
          title="Track your contacts"
          intro="Keep track of everyone you have reached out to. Coaches, employers, clubs. Small conversations lead to big opportunities."
        >
          <NetworkingTracker />
        </FloatingSection>
